    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: 'rgba(15,23,42,0.7)' }}>
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto animate-slide-up">
        ...
        <div className="flex border-b border-slate-100 px-6 pt-2">
          {([['stats', '⚡ 能力分析'], ['players', '👥 球员阵容'], ['coach', '🎖️ 主教练']] as const).map(([id, label]) => (
            <button
              key={id}
            ...
            <div className="space-y-5">
              <div className="flex items-center gap-4 p-4 bg-slate-50 rounded-xl">
                ...
                <div>
                  ...
                  <div className="text-slate-500 text-sm">{team.coachNationality} · {team.coachAge}岁</div>
                </div>
                <div className="ml-auto text-right">
          ...
          >
            ...
            <div className="space-y-2 mb-4">
              <div className="flex justify-between items-center text-xs">
                <span className="text-slate-500 flex items-center gap-1"><Sword className="w-3 h-3" />进攻</span>
              ...
              <div className="flex justify-between items-center text-xs">
                <span className="text-slate-500 flex items-center gap-1"><Shield className="w-3 h-3" />防守</span>
                <div className="flex items-center gap-2 flex-1 ml-3">
                  <div className="flex-1 h-1.5 bg-slate-100 rounded-full overflow-hidden">
              ...
              <div className="flex justify-between items-center text-xs">
                <span className="text-slate-500 flex items-center gap-1"><Activity className="w-3 h-3" />中场</span>
                <div className="flex items-center gap-2 flex-1 ml-3">
                  <div className="flex-1 h-1.5 bg-slate-100 rounded-full overflow-hidden">
